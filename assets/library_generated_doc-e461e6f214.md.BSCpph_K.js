import{g as _,o as c,c as a,j as n,a as s,k as l,a5 as p,t as i}from"./chunks/framework.B5tqjWbr.js";const d={class:"kb-download-actions"},m=["href"],B={class:"kb-archive-preview"},E={class:"kb-source-previews","aria-labelledby":"doc-e461e6f214-source-heading"},f={class:"kb-preview-panel kb-code-preview",open:""},h=["textContent"],C={class:"kb-preview-panel kb-code-preview"},P=["textContent"],I={class:"kb-preview-panel kb-code-preview"},u=["textContent"],L={class:"kb-preview-panel kb-code-preview"},v=["textContent"],D={class:"kb-preview-panel kb-code-preview"},K=["textContent"],w={class:"kb-preview-panel kb-code-preview"},S=["textContent"],M={class:"kb-preview-panel kb-code-preview"},R=["textContent"],x={class:"kb-preview-panel kb-code-preview"},k=["textContent"],T={class:"kb-preview-panel kb-code-preview"},A=["textContent"],b={class:"kb-preview-panel kb-code-preview"},g=["textContent"],O={class:"kb-preview-panel kb-code-preview"},y=["textContent"],N={class:"kb-preview-panel kb-code-preview"},X=["textContent"],U={class:"kb-preview-panel kb-code-preview"},W=["textContent"],j={class:"kb-preview-panel kb-code-preview"},G=["textContent"],F={class:"kb-preview-panel kb-code-preview"},V=["textContent"],H={class:"kb-preview-panel kb-code-preview"},Q=["textContent"],J=JSON.parse('{"title":"ESP32-IDF练习源码","description":"嵌入式 / ESP32 · ZIP · 621.5 KB","frontmatter":{"search":false,"aside":false,"pageClass":"kb-wide-document","title":"ESP32-IDF练习源码","description":"嵌入式 / ESP32 · ZIP · 621.5 KB","searchTitle":"ESP32-IDF练习源码","searchPath":"嵌入式 / ESP32","searchType":"ZIP"},"headers":[],"relativePath":"library/generated/doc-e461e6f214.md","filePath":"library/generated/doc-e461e6f214.md","lastUpdated":null}'),q={name:"library/generated/doc-e461e6f214.md"},$=Object.assign(q,{setup(Y){const o=_("/uploads/raw/%E5%B5%8C%E5%85%A5%E5%BC%8F/04-ESP32/ESP32-IDF%E7%BB%83%E4%B9%A0%E6%BA%90%E7%A0%81.zip"),r=`    416 B  01_led/.devcontainer/devcontainer.json
  ...
  70.9 KB  26_wifi_tcpserver/components/LCD/lcdfont.h
   ...
   2.4 KB  s3n8/mqtt/README.md`,t=[`ESP32-IDF练习源码

本压缩包由开源协会知识库从学习目录中自动精选生成。
已排除安装包、视频、编译缓存、目标文件、可执行文件、私钥和大型第三方依赖。
部分工程需要通过对应 IDE、SDK 或配置文件重新生成依赖后再编译。`,`| Supported Targets | ESP32 | ESP32-C2 | ESP32-C3 | ESP32-C6 | ESP32-H2 | ESP32-S2 | ESP32-S3 |\r
| ----------------- | ----- | -------- | -------- | -------- | -------- | -------- | -------- |\r
\r
# _Sample project_\r
\r
(See the README.md file in the upper level 'examples' directory for more information about examples.)\r
\r
This is the simplest buildable example. The example is used by command \`idf.py create-project\`\r
that copies the project to user specified path and set it's name. For more information follow the [docs page](https://docs.espressif.com/projects/esp-idf/en/latest/api-guides/build-system.html#start-a-new-project)\r
\r
\r
\r
## How to use example\r
We encourage the users to use the example as a template for the new projects.\r
A recommended way is to follow the instructions on a [docs page](https://docs.espressif.com/projects/esp-idf/en/latest/api-guides/build-system.html#start-a-new-project).\r
\r
## Example folder contents\r
\r
The project **sample_project** contains one source file in C language [main.c](main/main.c). The file is located in folder [main](main).\r
\r
ESP-IDF projects are built using CMake. The project build configuration is contained in \`CMakeLists.txt\`\r
files that provide set of directives and instructions describing the project's source files and targets\r
(executable, library, or both). \r
\r
Below is short explanation of remaining files in the project folder.\r
\r
\`\`\`\r
├── CMakeLists.txt\r
├── main\r
│   ├── CMakeLists.txt\r
│   └── main.c\r
└── README.md                  This is the file you are currently reading\r
\`\`\`\r
Additionally, the sample project contains Makefile and component.mk files, used for the legacy Make based build system. \r
They are not used or needed when building with CMake and idf.py.\r
`,`| Supported Targets | ESP32 | ESP32-C2 | ESP32-C3 | ESP32-C6 | ESP32-H2 | ESP32-S2 | ESP32-S3 |\r
| ----------------- | ----- | -------- | -------- | -------- | -------- | -------- | -------- |\r
\r
# _Sample project_\r
\r
...
{\r
    esp_err_t ret;\r
\r
    ret = nvs_flash_init(); /* 初始化 NVS */\r
    if (ret == ESP_ERR_NVS_NO_FREE_PAGES || ret == ESP_ERR_NVS_NEW_VERSION_FOUND)\r
    {\r
...
{\r
    ...
    uint8_t len = 0;\r
    uint16_t times = 0;\r
    unsigned char data[RX_BUF_SIZE] = {0};\r
\r
    ret = nvs_flash_init(); /* 初始化 NVS */\r
    if (ret == ESP_ERR_NVS_NO_FREE_PAGES || ret == ESP_ERR_NVS_NEW_VERSION_FOUND)\r
    {\r
    ...
    while (1)\r
    {\r
        uart_get_buffered_data_len(USART_UX,(size_t *)&len);\r
        if(len>0)\r
        {\r
            memset(data,0,RX_BUF_SIZE);\r
            //printf("\\nthe message you send is: \\r\\n");\r
            uart_write_bytes(USART_UX,(const char*)buf,strlen((const char*)buf));\r
            uart_read_bytes(USART_UX, data ,len,100);\r
            uart_write_bytes(USART_UX,(const char*)data,strlen((const char*)data));\r
        }\r
        else\r
        {\r
            times++;\r
...
#include "esp_chip_info.h"\r
#include "esp_psram.h"\r
#include "esp_flash.h"\r
#include "led.h"\r
#include "time.h"\r
/**\r
 * @brief 程序入口\r
...
{\r
    ...
    led_init();\r
    esptim_int_init(500000);//初始化定时器，tps=500000，即500ms触发一次\r
    while (1)\r
    {\r
\r
    }\r
...
{\r
    uint8_t record;\r
    esp_err_t ret;\r
    gptimer_event_t g_tim_evente;\r
    ret = nvs_flash_init(); /* 初始化 NVS */\r
    ...
    led_init();                   /* 初始化 LED */\r
    gptim_int_init(100, 1000000); /* 初始化通用定时器 */\r
    while (1)\r
    {\r
        record = 1;\r
        /* 打印通用定时器发生一次计数事件后获取到的值 */\r
        if (xQueueReceive(queue, &g_tim_evente, 2000))\r
        {\r
            ESP_LOGI("GPTIMER_ALARM",\r
                     "定时器报警, 计数值： %llu",\r
                     g_tim_evente.event_count);\r
            record--;\r
        }\r
        else\r
        {\r
            ESP_LOGW("GPTIMER_ALARM", "错过一次计数事件");\r
        }\r
    }\r
    vQueueDelete(queue);\r
}\r
`,`#include "freertos/FreeRTOS.h"\r
#include "freertos/task.h"\r
#include "driver/gpio.h"\r
...
{\r
    esp_err_t rets;\r
    \r
    rets = nvs_flash_init();            /* 初始化NVS */\r
\r
    if (rets == ESP_ERR_NVS_NO_FREE_PAGES || rets == ESP_ERR_NVS_NEW_VERSION_FOUND)\r
    {\r
        ESP_ERROR_CHECK(nvs_flash_erase());\r
        rets = nvs_flash_init();\r
    }\r
\r
    led_init();                         /* 初始化LED */\r
    key_init();                         /* 初始化按键 */\r
    wdt_init(5000, 1000000);            /* 初始化定时器 */\r
    LED(0);                             /* LED灯常亮 */\r
\r
    while (1)\r
    {\r
        if (key_scan(0) == BOOT_PRES)   /* 如果BOOT按下则喂狗 */\r
        {\r
            restart_timer(1000000);     /* 喂狗 */\r
        }\r
\r
        vTaskDelay(10);                 /* LED闪烁 */\r
    }\r
}\r
`,`#include "freertos/FreeRTOS.h"\r
#include "freertos/task.h"\r
...
\r
    ...
    {\r
        ...
        else if(ledpwmval<=5)\r
        {\r
            dir=1;\r
        }\r
        /* 设置占空比 */\r
        pwm_set_duty(ledpwmval);\r
    }\r
}\r
`,`#include "freertos/FreeRTOS.h"\r
#include "freertos/task.h"\r
...
\r
    pwm_init(13,5000); /* 初始化 PWM */\r
    while (1)\r
    {\r
        vTaskDelay(10);\r
        pwm_set_duty(LEDC_PWM_DUTY); /* 设置占空比 */\r
    }\r
}\r
`,`#include "freertos/FreeRTOS.h"\r
#include "freertos/task.h"\r
...
\r
\r
i2c_obj_t i2c0_master;\r
void show_mesg(void)\r
{\r
    /* 串口输出实验信息 */\r
    printf("\\n");\r
    printf("********************************\\n");\r
...
\r
    led_init();                         /* 初始化LED */\r
    i2c0_master = iic_init(I2C_NUM_0);  /* 初始化IIC0 */\r
    xl9555_init(i2c0_master);           /* 初始化XL9555 */\r
    show_mesg();                        /* 显示实验信息 */\r
\r
    while(1)\r
    {\r
        key = xl9555_key_scan(0);\r
        \r
        switch (key)\r
        {\r
            case KEY0_PRES:\r
            {\r
                ...
                xl9555_pin_write(BEEP_IO, 0);\r
                break;\r
            }\r
            case KEY1_PRES:\r
            {\r
                printf("KEY1 has been pressed \\n");\r
                xl9555_pin_write(BEEP_IO, 1);\r
                break;\r
            }\r
            case KEY2_PRES:\r
            {\r
...
#include "driver/gpio.h"\r
\r
#define KEY1_INT_GPIO_PIN GPIO_NUM_0\r
#define KEY1 gpio_get_level(KEY1_INT_GPIO_PIN)\r
void exit_init(void);\r
\r
#endif`,`#ifndef __LED_H__\r
#define __LED_H__\r
\r
#include "driver/gpio.h"\r
\r
#define LED_GPIO_PIN GPIO_NUM_1\r
\r
enum GPIO_OUTPUT_STATE\r
{\r
    PIN_RESET,\r
    PIN_SET\r
};\r
\r
#define LED(x)          do { x ?                                      \\\r
                             gpio_set_level(LED_GPIO_PIN, PIN_SET) :  \\\r
                             gpio_set_level(LED_GPIO_PIN, PIN_RESET); \\\r
                        } while(0)  /* LED翻转 */\r
\r
#define LED_TOGGLE()    do { gpio_set_level(LED_GPIO_PIN, !gpio_get_level(LED_GPIO_PIN)); } while(0)  /* LED翻转 */\r
\r
...
\r
	...
	"runArgs": ["--privileged"]
}`];return(Z,e)=>(c(),a("div",null,[e[19]||(e[19]=n("h1",{id:"esp32-idf练习源码",tabindex:"-1"},[s("ESP32-IDF练习源码 "),n("a",{class:"header-anchor",href:"#esp32-idf练习源码","aria-label":'Permalink to "ESP32-IDF练习源码"'},"​")],-1)),e[20]||(e[20]=n("div",{class:"kb-file-meta"},[n("span",null,[n("strong",null,"目录"),s("嵌入式 / ESP32")]),n("span",null,[n("strong",null,"格式"),s("ZIP")]),n("span",null,[n("strong",null,"大小"),s("621.5 KB")])],-1)),n("p",d,[n("a",{class:"kb-download-button kb-download-button-secondary",href:l(o),download:""},"下载完整源码包",8,m)]),e[21]||(e[21]=n("h2",{id:"在线预览",tabindex:"-1"},[s("在线预览 "),n("a",{class:"header-anchor",href:"#在线预览","aria-label":'Permalink to "在线预览"'},"​")],-1)),e[22]||(e[22]=n("div",{class:"kb-preview-summary"},[n("span",null,[n("strong",null,"501"),s(" 个文件")]),n("span",null,[n("strong",null,"255"),s(" 个目录")]),n("span",null,[n("strong",null,"2.4 MB"),s(" 解压后大小")])],-1)),n("div",B,[e[18]||(e[18]=p('<div class="kb-extension-list" aria-label="文件类型统计"><span><strong>C</strong>167</span><span><strong>H</strong>155</span><span><strong>TXT</strong>88</span><span><strong>MD</strong>31</span><span><strong>JSON</strong>29</span><span><strong>CSV</strong>29</span><span><strong>PY</strong>2</span></div>',1)),n("details",{class:"kb-preview-panel kb-archive-index"},[e[0]||(e[0]=n("summary",null,"查看完整目录 · 501 个文件",-1)),n("pre",{textContent:r})]),n("section",E,[e[17]||(e[17]=n("h3",{id:"doc-e461e6f214-source-heading"},"可读文件预览",-1)),n("details",f,[e[1]||(e[1]=n("summary",null,[n("span",null,"README.txt"),n("small",null,"300 B")],-1)),n("pre",null,[n("code",{textContent:i(t[0])},null,8,h)])]),n("details",C,[e[2]||(e[2]=n("summary",null,[n("span",null,"01_led/README.md"),n("small",null,"1.7 KB")],-1)),n("pre",null,[n("code",{textContent:i(t[1])},null,8,P)])]),n("details",I,[e[3]||(e[3]=n("summary",null,[n("span",null,"02_key_led_EXTI_UART/README.md"),n("small",null,"1.7 KB")],-1)),n("pre",null,[n("code",{textContent:i(t[2])},null,8,u)])]),n("details",L,[e[4]||(e[4]=n("summary",null,[n("span",null,"01_led/main/main.c"),n("small",null,"574 B")],-1)),n("pre",null,[n("code",{textContent:i(t[3])},null,8,v)])]),n("details",D,[e[5]||(e[5]=n("summary",null,[n("span",null,"02_key_led_EXTI_UART/main/main.c"),n("small",null,"1.4 KB")],-1)),n("pre",null,[n("code",{textContent:i(t[4])},null,8,K)])]),n("details",w,[e[6]||(e[6]=n("summary",null,[n("span",null,"03_ESPTIMER/main/main.c"),n("small",null,"695 B")],-1)),n("pre",null,[n("code",{textContent:i(t[5])},null,8,S)])]),n("details",M,[e[7]||(e[7]=n("summary",null,[n("span",null,"04_GPTIMER/main/main.c"),n("small",null,"1.2 KB")],-1)),n("pre",null,[n("code",{textContent:i(t[6])},null,8,R)])]),n("details",x,[e[8]||(e[8]=n("summary",null,[n("span",null,"05_watch_dog/main/main.c"),n("small",null,"1.0 KB")],-1)),n("pre",null,[n("code",{textContent:i(t[7])},null,8,k)])]),n("details",T,[e[9]||(e[9]=n("summary",null,[n("span",null,"06_SW_PWM/main/main.c"),n("small",null,"918 B")],-1)),n("pre",null,[n("code",{textContent:i(t[8])},null,8,A)])]),n("details",b,[e[10]||(e[10]=n("summary",null,[n("span",null,"07_HW_PWM/main/main.c"),n("small",null,"611 B")],-1)),n("pre",null,[n("code",{textContent:i(t[9])},null,8,g)])]),n("details",O,[e[11]||(e[11]=n("summary",null,[n("span",null,"08_IIC_EXIO/main/main.c"),n("small",null,"2.3 KB")],-1)),n("pre",null,[n("code",{textContent:i(t[10])},null,8,y)])]),n("details",N,[e[12]||(e[12]=n("summary",null,[n("span",null,"02_key_led_EXTI_UART/components/EXIT/exit.h"),n("small",null,"187 B")],-1)),n("pre",null,[n("code",{textContent:i(t[11])},null,8,X)])]),n("details",U,[e[13]||(e[13]=n("summary",null,[n("span",null,"03_ESPTIMER/components/LED/led.h"),n("small",null,"590 B")],-1)),n("pre",null,[n("code",{textContent:i(t[12])},null,8,W)])]),n("details",j,[e[14]||(e[14]=n("summary",null,[n("span",null,"04_GPTIMER/components/LED/led.h"),n("small",null,"590 B")],-1)),n("pre",null,[n("code",{textContent:i(t[13])},null,8,G)])]),n("details",F,[e[15]||(e[15]=n("summary",null,[n("span",null,"01_led/.devcontainer/devcontainer.json"),n("small",null,"416 B")],-1)),n("pre",null,[n("code",{textContent:i(t[14])},null,8,V)])]),n("details",H,[e[16]||(e[16]=n("summary",null,[n("span",null,"02_key_led_EXTI_UART/.devcontainer/devcontainer.json"),n("small",null,"416 B")],-1)),n("pre",null,[n("code",{textContent:i(t[15])},null,8,Q)])])])])]))}});export{J as __pageData,$ as default};
